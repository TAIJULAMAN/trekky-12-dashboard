      ...
      <div className=" flex items-center justify-center">
        ...
        <div className="flex-1 flex flex-col justify-center px-8 py-12 lg:px-16 bg-white">
          <div className="container w-full mx-auto">
            ...
            {/* Header */}
            <div className="mb-8">
              <h1 className="text-3xl font-bold text-[#313131] mb-2">Forgot your password?</h1>
              <p className="text-[#313131]">Don’t worry, happens to all of us. Enter your email below to recover your password.</p>
            </div>
