      ...
      <div className="flex-1 flex flex-col justify-center px-8 py-12 lg:px-16 bg-white">
        <div className="max-w-md w-full mx-auto">
          ...
          <div className="flex items-center mb-12">
            ...
            <span className="ml-3 text-xl font-bold text-gray-800">U Tee Hub</span>
          </div>

          {/* Header */}
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Login</h1>
            <p className="text-gray-600">Login to access your U Tee Hub account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full bg-cyan-500 text-white py-3 px-4 rounded-lg font-medium hover:bg-cyan-600 focus:ring-4 focus:ring-cyan-200 transition-all duration-200 transform hover:scale-[1.02]"
            >
              Login
            </button>
          </form>
          ...
          <div className="mt-8">
            ...
            <div className="mt-6 grid grid-cols-2 gap-4">
              <button className="flex items-center justify-center px-4 py-3 border border-gray-300 rounded-lg bg-white hover:bg-gray-50 focus:ring-2 focus:ring-cyan-500 transition-all duration-200 transform hover:scale-[1.02]">
